...
public class EarthquakeCityMap extends PApplet {
	...
	private void addKey() {	
		...
		fill(color(235, 52, 128));
		triangle(45, 115, 55, 95, 65, 115);
		fill(color(255,255,255));
		ellipse(55, 135, 20, 20);
		...
		fill(color(0,0,255));
		ellipse(55, 250, 20, 20);
		
		fill(color(255,0,0));
		ellipse(55, 280, 20, 20);
	...
	private void printQuakes() 
	{
		...
		int ocean_quake_counter = 0;
		for(Marker cm : countryMarkers) 
		{
			String country = (String) cm.getProperty("name"); 
			
			int quake_counter = 0 ;
			ocean_quake_counter=0;
			for(Marker m : quakeMarkers) 
			{
				EarthquakeMarker em = (EarthquakeMarker) m;
				if(em.isOnLand) 
				{
					if(country.equals(m.getProperty("country"))) 
					{
						quake_counter++;
					}
		...
		System.out.println("OCEAN QUAKES: "+ocean_quake_counter);
